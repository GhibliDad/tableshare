...
Event.create( title: "Maria's Meatballz!", description: "tennis ball sized authentic Swedish meatballs, just like Björn used to make!", address: "Ålgrytevägen 5, 127 32 Skärholmen, Sweden", ingredients: "mince meat, onions, salt, butter, pepper", available_seats: 8, user: User.first)
Event.create( title: "Maria's Sill & Potatis!", description: "Traditional Swedish Sill & Potatoes! with a russian serving of tennis", address: "LM Ericssons Väg 14, 126 27 Hägersten, Sweden", ingredients: "Sill (herring), potatoes", available_seats: 4, user: User.first)
