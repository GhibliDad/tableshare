...
User.create!( first_name: "Björn", last_name: "Borg", email: "bjorn@bjorn.com", username: "bjorne", password: "qwerty", phone_number: "0123456789", about: "Since i retired from competitive tennis, I now make underwear and enjoy meatballs", allergies: ["John McEnroe"], start_time: Faker::Time.between_dates(from: Date.today - 1, to: Date.today, period: :night), end_time: Faker::Time.between_dates(from: Date.today - 1, to: Date.today, period: :night))
Event.create!( title: "Maria's Meatballz!", description: "tennis ball sized authentic Swedish meatballs, just like Björn used to make!", address: "Ålgrytevägen 5, 127 32 Skärholmen, Sweden", ingredients: "mince meat, onions, salt, butter, pepper", available_seats: 8, price: 100,start_time: Faker::Time.between_dates(from: Date.today - 1, to: Date.today, period: :night), end_time: Faker::Time.between_dates(from: Date.today - 1, to: Date.today, period: :night), user: User.first)
